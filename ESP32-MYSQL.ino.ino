...
const char* ssid = "STUDENT-175 5325";
...
void loop() {
  ...
  if(WiFi.status()== WL_CONNECTED) {
    ...
    http.begin("http://192.168.100.175:8080/ESP32_MySQL_Database/Final/getdata.php");  //--> Specify request destination
    ...
    http.begin("http://192.168.100.175:8080/ESP32_MySQL_Database/Final/updateDHT11data_and_recordtable.php");  //--> Specify request destination
    http.addHeader("Content-Type", "application/x-www-form-urlencoded");  //--> Specify content-type header
